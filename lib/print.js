...
${chalk.hex('#FE0041').bold('│')}${chalk.yellowBright('Fecha:')} ${chalk.blueBright(new Date(m.messageTimestamp ? 1000 * (m.messageTimestamp.low || m.messageTimestamp) : Date.now()).toLocaleDateString("es-ES", { timeZone: "America/Argentina_Buenos_Aires", day: 'numeric', month: 'long', year: 'numeric' }))}
